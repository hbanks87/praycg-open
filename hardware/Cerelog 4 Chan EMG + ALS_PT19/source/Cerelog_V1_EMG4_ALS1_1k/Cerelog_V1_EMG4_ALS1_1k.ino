...
// CH1-4: differential EMG gain 24; CH5: divided ALS gain 1; CH6-8: powered down.
...
static const regVal_pair ADS1299_REGISTER_LS[] = {
  ...
  {0x09, 0b00000000}, {0x0A, 0b10000001}, {0x0B, 0b10000001}, {0x0C, 0b10000001},
...
void report_configuration() {
  Serial.print("CERELOG_CFG {\"firmware\":\"CERELOG_V1_EMG4_ALS1_1K_V1\",");
  Serial.print("\"rate_hz\":1000,\"stream_baud\":460800,\"gains\":[24,24,24,24,1,0,0,0],");
  Serial.print("\"active_channels\":[1,2,3,4,5],\"bias_driver\":false,\"readback_ok\":");
