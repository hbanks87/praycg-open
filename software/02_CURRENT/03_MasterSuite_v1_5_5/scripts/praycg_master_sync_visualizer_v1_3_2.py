...
EVENT_BGR = {
    ...
    "artifact": (50,50,180), "als": (255,255,255), "nip": (90,255,220), "bit": (40,255,210), "cii": (80,210,255), "iaq": (60,180,255), "cet": (220,220,80), "eet": (200,160,255), "cet_eet": (210,190,255), "immersion": (90,255,220), "mred_itp": (255,210,90), "mred_itp_candidate": (255,235,60), "acg_complexity": (180,255,60), "ocu_blink_release": (255,160,90), "itp": (255,210,90), "other": (160,160,160)
}
PUBLIC_CATS = {"annotation","candidate_kht","kht_topo","mred","tti","tti_positive","topo_osm","g2theta","postpeak_pncc","nip","bit","cii","iaq","cet","eet","cet_eet","immersion","mred_itp","mred_itp_candidate","acg_complexity","ocu_blink_release","itp","protocol"}
    ...
    if args.analysis_out:
        ...
        try:
            ...
            for name in [
                ...
                "cet_tracking_summary.csv", "eet_endogenous_echo_tracking.csv", "mred_itp_visual_overlay.csv", "acg_event_table.csv", "ocu_event_table.csv", "mred_itp_anchor_summary.csv"
            ]:
                p = tables / name
