#!/usr/bin/env python3
"""
PRAYCG Master Synchronization Visualizer v1.2.2
...
def launch_gui() -> int:
    ...
    class App(tk.Tk):
        ...
        def build(self):
            tk.Label(self.body, text="PRAYCG Master Synchronization Visualizer v1.2.2", font=("Arial", 15, "bold")).pack(pady=10)
...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="PRAYCG Master Synchronization Visualizer v1.2.2")
...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="PRAYCG Master Synchronization Visualizer v1.2.2 with Control/Target/Override condition slicing")
    p.add_argument("--gui", action="store_true", help="Launch Tkinter GUI.")
    p.add_argument("--demo", action="store_true", help="Render a synthetic 30-second demo without XDF.")
    p.add_argument("--xdf", default="", help="Input XDF file.")
    p.add_argument("--features", default="", help="Optional precomputed feature CSV. If provided, raw XDF processing is skipped.")
...
def launch_gui() -> int:
    ...
    class App(tk.Tk):
        ...
        def build(self):
            ...
            ttk.Label(pad, text="PRAYCG Master Synchronization Visualizer v1.2.2.1", font=("Arial", 15, "bold")).pack(anchor="w")
