...
EVENT_BGR = {
    ...
    "artifact": (50,50,180), "als": (255,255,255), "nip": (90,255,220), "bit": (40,255,210), "cii": (80,210,255), "iaq": (60,180,255), "cet": (220,220,80), "eet": (200,160,255), "cet_eet": (210,190,255), "immersion": (90,255,220), "other": (160,160,160)
}
PUBLIC_CATS = {"annotation","candidate_kht","kht_topo","mred","tti","tti_positive","topo_osm","g2theta","postpeak_pncc","nip","bit","cii","iaq","cet","eet","cet_eet","immersion","protocol"}
    ...
    if args.analysis_out:
        ...
        try:
            ...
            for name in [
                ...
                "cet_tracking_summary.csv", "eet_endogenous_echo_tracking.csv"
            ]:
                p = tables / name
